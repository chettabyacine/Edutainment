    ...
    if (this.usesInput) {
      ...
      return QuestionQCM(
        ...
        choices: (this.type == 1)? [
          ...
          SvgPicture.asset('assets/geometric shapes/2D shapes filled/${choices[0].toLowerCase()}.svg'),
          SvgPicture.asset('assets/geometric shapes/2D shapes filled/${choices[1].toLowerCase()}.svg'),
          SvgPicture.asset('assets/geometric shapes/2D shapes filled/${choices[2].toLowerCase()}.svg'),
          SvgPicture.asset('assets/geometric shapes/2D shapes filled/${choices[3].toLowerCase()}.svg'),
        ],
      );
    }
  }
